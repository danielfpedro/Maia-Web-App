 ...
 * @property \App\Model\Table\PhonesCompaniesTable|\Cake\ORM\Association\BelongsTo $PhonesCompanies
 *
...
class PhonesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('PhonesCompanies', [
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['company_id'], 'PhonesCompanies'));
